...
Struct[{
    ...
    Optional['cache-config-mutate'] => Boolean,
    Optional['cache-embedded-authorization-max-count'] => Integer,
    Optional['cache-embedded-client-sessions-max-count'] => Integer,
    Optional['cache-embedded-crl-max-count'] => Integer,
    Optional['cache-embedded-keys-max-count'] => Integer,
    ...
    Optional['cache-embedded-mtls-rotation-interval-days'] => Integer,
    ...
    Optional['cache-embedded-network-bind-address'] => Stdlib::IP::Address,
    Optional['cache-embedded-network-bind-port'] => Stdlib::Port,
    Optional['cache-embedded-network-external-address'] => Stdlib::IP::Address,
    Optional['cache-embedded-network-external-port'] => Stdlib::Port,
    Optional['cache-embedded-offline-client-sessions-max-count'] => Integer,
    Optional['cache-embedded-offline-sessions-max-count'] => Integer,
    Optional['cache-embedded-realms-max-count'] => Integer,
    Optional['cache-embedded-sessions-max-count'] => Integer,
    Optional['cache-embedded-users-max-count'] => Integer,
    Optional['cache-metrics-histograms-enabled'] => Boolean,
    Optional['cache-remote-backup-sites'] => Array[String[1]],
    ...
    Optional['cache-remote-tls-enabled'] => Boolean,
